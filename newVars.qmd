...
spotify_songs$duraion_mins = spotify_songs$duration_ms/60000
...
@tbl-newvars describes 8 new variables, classicalness, title.words, norm.loudness, norm.tempo, itensity, livetrack, duration_mins, speechiness_cat, created from the Spotify dataset. The table provides the class, range, and description of each new variable.
